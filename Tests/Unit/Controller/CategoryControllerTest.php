...
/**
 * Test case for class Webschuppen\WsProducts\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Webschuppen\WsProducts\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Webschuppen\\WsProducts\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView() {
		...
		$categoryRepository = $this->getMock('Webschuppen\\WsProducts\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
