...
/**
 * Test case for class \Webschuppen\WsProducts\Domain\Model\ApplicationDescription.
 *
 ...
 */
class ApplicationDescriptionTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Webschuppen\WsProducts\Domain\Model\ApplicationDescription
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Webschuppen\WsProducts\Domain\Model\ApplicationDescription();
	}
	 ...
	 * @test
	 */
	public function getApplicationDescriptionTextReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getApplicationDescriptionText()
		);
	}
	 ...
	 * @test
	 */
	public function setApplicationDescriptionTextForStringSetsApplicationDescriptionText() {
		$this->subject->setApplicationDescriptionText('Conceived at T3CON10');
